...
linked_page = Contentr::Page.create!(:name => 'Article', :parent => linked_page, :linked_to => 'articles#show')
linked_page.paragraphs << Contentr::HtmlParagraph.new(:area_name => 'body', :body => 'Content for articles#show')
linked_page.publish!

linked_page = Contentr::Page.create!(:name => "Article ID #{first_article.id}", :linked_to => "articles#show:#{first_article.id}")
