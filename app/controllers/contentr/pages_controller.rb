class Contentr::PagesController < Contentr::ApplicationController
  ...
  def index
    @area_containing_element = Contentr::Page.find_by(slug: params[:slug].split('_').last, language: I18n.locale.to_s)
    if @area_containing_element.nil? && I18n.locale != I18n.default_locale
      @area_containing_element = Contentr::Page.find_by(slug: params[:slug].split('_').last, language: I18n.default_locale.to_s)
    end
