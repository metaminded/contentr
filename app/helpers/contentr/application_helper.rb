module Contentr
  module ApplicationHelper
    ...
    def contentr_edit_page_link(page)
      if page.visible?
        link_to fa_icon(:eye, text: t('contentr.hide_page')), contentr.hide_admin_page_path(page), class: 'btn btn-danger'
      else
        link_to fa_icon(:eye, text: t('contentr.publish_page')), contentr.publish_admin_page_path(page), class: 'btn btn-danger'
      end
