class Contentr::PageTypeTabulatrData < Tabulatr::Data
  search :name
  # column :edit, header: '', sortable: false,  filter: false, width: '30px' do |rec|
  #  "#" # edit_link edit_backend_tariff_path(rec)
  # end
  # column :destroy, header: '', sortable: false,  filter: false, width: '30px', classes: 'hidden-phone hidden-tablet' do |rec|
